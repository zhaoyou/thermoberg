 ...
 *
 */
public class CarHisData implements Serializable {
	...
	public CarHisData(int aid1,int aid2,int aid3,Double t1,Double t2,Double t3, Double latitude,int latitude_dir,Double longitude,int longitude_dir,String time,int isalarm){
		super();
		this.aid1 = aid1;
		this.aid2 = aid2;
		this.aid3 = aid3;
