...
public class HisCarData {
	...
	public HisCarData(Long startupid,Double t1,Double t2,Double t3, Double latitude,int latitude_dir,Double longitude,int longitude_dir,String time,int isalarm){
		super();
