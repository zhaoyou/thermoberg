...
public class PhoneCaller extends Service {
	...
	static {
		...
		try {
			...
			url = new URL(baseUrl,
					"http://10.0.0.1:8090/Services/TelephoneService?wsdl");
		} catch (MalformedURLException e) {
			logger
					.warning("Failed to create URL for the wsdl Location: 'http://10.0.0.1:8090/Services/TelephoneService?wsdl', retrying as a local file");
