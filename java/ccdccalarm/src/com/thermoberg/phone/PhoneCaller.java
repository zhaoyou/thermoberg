...
public class PhoneCaller extends Service {
	...
	private final static Logger logger = Logger
			.getLogger(com.thermoberg.phone.PhoneCaller.class.getName());

	static {
		URL url = null;
		try {
			URL baseUrl;
			baseUrl = com.thermoberg.phone.PhoneCaller.class.getResource(".");
			url = new URL(baseUrl,
					"http://192.168.0.50/Services/TelephoneService?wsdl");
		} catch (MalformedURLException e) {
			logger
					.warning("Failed to create URL for the wsdl Location: 'http://192.168.0.50/Services/TelephoneService?wsdl', retrying as a local file");
