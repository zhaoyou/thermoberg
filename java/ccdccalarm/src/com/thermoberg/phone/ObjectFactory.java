 ...
 * element interface generated in the com.thermoberg.phone package.
 * <p>
...
public class ObjectFactory {
	...
	private final static QName _StopCallPhoneNumber_QNAME = new QName(
			"http://www.thermoberg.com/Services/TelephoneService",
			"phoneNumber");
	private final static QName _StopCallKey_QNAME = new QName(
			"http://www.thermoberg.com/Services/TelephoneService", "Key");
	...
	private final static QName _Base64Binary_QNAME = new QName(
			"http://schemas.microsoft.com/2003/10/Serialization/",
			"base64Binary");
	private final static QName _SendMessageKey_QNAME = new QName(
			"http://www.thermoberg.com/Services/TelephoneService", "key");
	private final static QName _SendMessageMessage_QNAME = new QName(
			"http://www.thermoberg.com/Services/TelephoneService", "message");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of
	 * schema derived classes for package: com.thermoberg.phone
	 * 
	 */
	...
	/**
	 * Create an instance of {@link StopCall }
	 * 
	 */
	...
	/**
	 * Create an instance of {@link StopCallResponse }
	 * 
	 */
	public StopCallResponse createStopCallResponse() {
		return new StopCallResponse();
	}
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://www.thermoberg.com/Services/TelephoneService", name = "phoneNumber", scope = StopCall.class)
	public JAXBElement<String> createStopCallPhoneNumber(String value) {
		return new JAXBElement<String>(_StopCallPhoneNumber_QNAME,
				String.class, StopCall.class, value);
	}
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://www.thermoberg.com/Services/TelephoneService", name = "Key", scope = StopCall.class)
	public JAXBElement<String> createStopCallKey(String value) {
		return new JAXBElement<String>(_StopCallKey_QNAME, String.class,
				StopCall.class, value);
	}
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://www.thermoberg.com/Services/TelephoneService", name = "phoneNumber", scope = Call.class)
	public JAXBElement<String> createCallPhoneNumber(String value) {
		return new JAXBElement<String>(_StopCallPhoneNumber_QNAME,
				String.class, Call.class, value);
	}
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://www.thermoberg.com/Services/TelephoneService", name = "Key", scope = Call.class)
	public JAXBElement<String> createCallKey(String value) {
		return new JAXBElement<String>(_StopCallKey_QNAME, String.class,
				Call.class, value);
	}
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://www.thermoberg.com/Services/TelephoneService", name = "phoneNumber", scope = SendMessage.class)
	public JAXBElement<String> createSendMessagePhoneNumber(String value) {
		return new JAXBElement<String>(_StopCallPhoneNumber_QNAME,
				String.class, SendMessage.class, value);
	}
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://www.thermoberg.com/Services/TelephoneService", name = "key", scope = SendMessage.class)
	public JAXBElement<String> createSendMessageKey(String value) {
		return new JAXBElement<String>(_SendMessageKey_QNAME, String.class,
				SendMessage.class, value);
	}
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://www.thermoberg.com/Services/TelephoneService", name = "message", scope = SendMessage.class)
	public JAXBElement<String> createSendMessageMessage(String value) {
		return new JAXBElement<String>(_SendMessageMessage_QNAME, String.class,
				SendMessage.class, value);
	}
