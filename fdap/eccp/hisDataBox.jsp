...
<title>查看${param.orgname }的小批零启停记录-&gt;查看历史数据</title>
    ...
    <div class="top">
      <table id="tb" border="0" cellspacing="0" cellpadding="0" >
        <tr id="tb1" >
          ...
          <img src=images/index/icon.gif width="9" height="10" /> 当前位置：查看${param.orgname }的小批零启停记录-&gt;查看历史数据</span>
          <a href="javascript:goAction('startUp.do','doBoxStartUpPage');">
      ...
      <table id="tb" border="0" cellspacing="0" cellpadding="0">
        <tr bgcolor="#CCCCCC">
          <td height="28" colspan="7" bgcolor="#dff4fc"><table width="980" border="0" height="27">
              <tr>
                <td width="69" height="23" style="border:none;">小批零名称：</td>
				...
				<logic:iterate id="hiscar" name="hiscarList" indexId="irow">
					...
					<tr ${outrow%2==1?"bgcolor='#f1f4f8'":"" }>
						...
						<c:if test="${outrow==2 }">平均值</c:if>
       					...
       					<td align="center"  nowrap="nowrap">${MMA==-300?"--":MMA }</td>
          ...
          <td colspan="6"><table width="100%" border="0" cellpadding="0" cellspacing="0" >
            <tr >
              ...
              <td width="100" style="border: none;">
    			...
    			<c:if test="${page!=1&&page!=null }">
              		<input type="button" value="首页" / class="inp_aa" onclick="javascript:firstPage('boxHis.do','doBoxHisPage');"/>
              	</c:if>
              </td>
              <td width="100" style="border: none;">
              	<c:if test="${page==1||page==null }">
    			...
    			<c:if test="${page!=1&&page!=null }">
              		<input type="button" value="上一页" / class="inp_bb" onclick="javascript:prePage('boxHis.do','doBoxHisPage');"/>
              	</c:if>
              </td>
              <td width="100" style="border: none;">
              	<c:if test="${page==carpagecount }">
    			...
    			<c:if test="${page!=carpagecount }">
              		<input type="button" value="下一页" / class="inp_cc" onclick="javascript:nextPage('boxHis.do','doBoxHisPage');"/>
              	</c:if>
              </td>
              <td width="100" style="border: none;">
              	<c:if test="${page==carpagecount }">
    			...
    			<c:if test="${page!=carpagecount }">
              		<input type="button" value="尾页" / class="inp_dd" onclick="javascript:lastPage('boxHis.do','doBoxHisPage');"/>
              	</c:if>
              </td>
              <td width="94" style="border: none;">&nbsp;</td>
